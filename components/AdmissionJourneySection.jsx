          ...
          {steps.map((item, idx) => {
            ...
            return (
              <ScrollReveal key={idx} delay={100 * (idx + 1)} direction="up">
                <div className="bg-[#faf8f5] border-2 border-slate-200/90 rounded-3xl p-5 flex flex-col justify-between hover:border-indigo-400 hover:shadow-lg transition-all h-full group">
                  <div>
