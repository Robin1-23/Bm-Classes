  ...
  const pillars = [
    {
      num: '01',
      icon: Target,
      tag: 'PEDAGOGY METHODOLOGY',
      title: 'Master concepts. Skip repetitive drills.',
      desc: 'Solve 15 high-yield Advanced problems per topic instead of 200+ duplicate template questions.',
      stats: '15 High-Yield Qs / Topic',
      versusText: 'vs 200+ Repeated Drills in Mass Factories',
      highlights: [
        'Curated 15-question sets per chapter',
        'Focus on JEE Advanced pattern twists',
        'Zero mechanical rote learning',
      ],
    },
    {
      num: '02',
      ...
      title: 'Weekly rank telemetry. No shocks.',
      desc: 'Weekly chapter diagnostics & 1-on-1 reviews keep your exact rank trajectory crystal clear.',
      stats: 'Weekly Diagnostic Reports',
      versusText: 'vs End-of-Term Surprise Marks',
      highlights: [
        'Weekly diagnostic test reports',
        '1-on-1 parent & mentor reviews',
        'Real-time percentile gap tracking',
      ],
    },
    {
      num: '03',
      icon: Users,
      tag: 'MICRO BATCH CAP',
      title: 'Known by name & specific gaps.',
      desc: 'Known individually by name, speed, and weak areas. Doubts cleared on the board the same day.',
      stats: 'Capped 10-15 Batch Limit',
      versusText: 'vs 200+ Crowded Mass Halls',
      highlights: [
