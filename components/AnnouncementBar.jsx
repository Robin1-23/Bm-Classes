...
export default function AnnouncementBar() {
  return (
    <div className="bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-300 text-slate-950 px-3 sm:px-6 py-2 border-b border-amber-500/20 shadow-xs relative z-50 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-2 text-center lg:text-left">
        ...
        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 max-w-full">
          <span className="inline-flex items-center gap-1.5 bg-slate-950 text-amber-300 px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider shadow-xs shrink-0">
